...
contract Functions1 {
    ...
    function setName(string memory _name) public {  // Writing function GAS
        name = _name;
    }

    function getName() public view returns(string memory) { // Reading function No GAS
        return name;
    }

    function resetName() public {   // Writing function GAS
        name = "Example 1";
    }
}
